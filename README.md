...
** Nota: ** En la explicación se asume que la persona que esta trabajando en este sabe sobre Linux y sus diferente herramientas como el firewall y selinux.
...
3.2.2 Reiniciar el servicio de HAProxy.
